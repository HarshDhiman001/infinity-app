    ...
    <div>
      ...
      <div style={{display:"flex",justifyContent:"center",gap:20}}>
        {[
          ...
          <button key={i} onClick={onLogin} style={{width:52,height:52,borderRadius:"50%",background:"#F4F7FD",border:"1px solid #E4EAF6",display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer"}}>
            {icon}
          </button>
        ))}
      </div>
